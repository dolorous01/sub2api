...
watch(() => route.fullPath, () => handle?.updateContext(context()))
...
<style scoped>
.image-canvas-host { position: relative; min-height: min(760px, calc(100vh - 8rem)); height: calc(100vh - 8rem); overflow: hidden; border: 1px solid rgb(226 232 240); background: rgb(248 250 252); }
...
:global(.dark) .image-canvas-host { border-color: rgb(51 65 85); background: rgb(15 23 42); }
