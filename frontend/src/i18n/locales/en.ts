export default {
  ...
  keys: {
    ...
    createdKeyTitle: 'Save your new API key',
    createdKeyWarning: 'Copy and store this API key securely before continuing.',
    copyCreatedKey: 'Copy API key',
  ...
  studio: {
    description: 'Create and organize images on an infinite canvas'
  },
  ...
  admin: {
    imageCanvas: {
      ...
      policyDescription: 'Shows all media models and current coverage. Order controls image fallback; audio and video use enabled state only.',
      enabled: 'Enable image canvas jobs',
      enabledDescription: 'Allow authenticated users to create image jobs from the canvas.',
      ...
      availableModelsDescription: 'Add a schedulable model to the end of the chain.',
      noModels: 'No schedulable image models are available.',
      atLeastOne: 'At least one model must be enabled.',
      auditTitle: 'Recent policy changes',
      conflict: 'The policy changed elsewhere. The latest version was loaded.',
      runtimeTitle: 'Runtime policy and parameter presets',
      runtimeDescription: 'Adjust async job capacity, result retention, and model parameter presets.',
      restoreDefaults: 'Restore startup defaults',
      workerState: 'Worker status',
      workerStopped: 'Stopped',
      workerCount: '{running} / {target} workers',
      storageState: 'Object storage',
      storageLocation: 'Storage location',
      objectLimit: 'Per-object limit',
      applyMode: 'Configuration',
      appliesImmediately: 'Applies immediately',
      restartRequired: 'Restart required',
      permanentAssetNotice: 'Canvas assets are permanent; result retention only applies to temporary job objects.',
      temporaryAssetNotice: 'Job objects follow the result retention period. Save assets that must be kept.',
      limitsTitle: 'Job capacity and retention',
      workerConcurrency: 'Global worker concurrency',
      workerConcurrencyHint: 'Scale-down waits for active jobs to finish.',
      maxActiveJobs: 'Active jobs per user',
      maxActiveJobsHint: 'Includes queued and running jobs.',
      taskTimeout: 'Total job timeout (seconds)',
      currentDuration: 'Current: {duration}',
      maxOutputs: 'Maximum outputs per job',
      maxInputs: 'Maximum reference images',
      resultRetention: 'Temporary result retention (seconds)',
      concurrencyNotice: 'Higher concurrency increases upstream traffic and server memory use. Scale-down does not cancel active image jobs.',
      defaultsTitle: 'Model defaults',
      defaultsDescription: 'Override the catalog defaults for dimensions, quality, format, and background.',
      addDefault: 'Add model default',
      noDefaultOverrides: 'Catalog defaults are currently in use.',
      presetsTitle: 'Custom parameter presets',
      presetsDescription: 'Add model-specific parameter bundles that users can select in the canvas.',
      addPreset: 'Add preset',
      noCustomPresets: 'No custom presets are configured.',
      model: 'Model',
      presetId: 'Preset ID',
      presetLabel: 'Display name',
      presetDefaultLabel: 'Custom preset {number}',
      experimentalPreset: 'Mark as experimental',
      ...
      customSizeHint: 'Longest edge up to {maxEdge}px; dimensions must be multiples of {multiple}; maximum aspect ratio {maxRatio}:1.',
      experimentalSize: 'This {model} size is experimental.',
      invalidLimits: 'Runtime limits must be integers within the supported ranges.',
      tooManyOverrides: 'The model default or custom preset count exceeds the server limit.',
      unknownModel: 'Model {model} is not currently schedulable.',
      duplicateDefault: 'Only one default override is allowed for model {model}.',
      invalidPreset: 'Preset IDs may contain letters, numbers, dots, underscores, and hyphens; display names are required.',
      duplicatePreset: 'Preset ID {id} already exists for model {model}.',
      invalidParameters: 'The parameter combination for model {model} is invalid.',
      durationSeconds: '{value} seconds',
      durationMinutes: '{value} minutes',
      durationHours: '{value} hours',
      durationDays: '{value} days',
      consoleLabel: 'Operations console',
      entrySettings: 'Entry switch',
      entrySwitch: 'User entry switch',
      entrySwitchHint: 'Controls canvas routes and new jobs',
      ...
      checking: 'Checking',
      checkPassed: 'Passed',
      checkFailed: 'Not eligible',
      checkPolicyBlocked: 'Schedulable, blocked by policy',
      checkModel: 'Non-billable check',
      schedulable: 'Schedulable',
      notSchedulable: 'Not schedulable',
      image: 'Image',
      video: 'Video',
      audio: 'Audio',
      reasonGroupFilter: 'Filtered by group model allowlist',
      reasonNoGroup: 'No eligible account group',
      reasonUnknown: 'Unknown model',
      reasonNoAccount: 'No schedulable account',
      addModel: 'Add to model chain',
      selectModel: 'Select a schedulable model',
      addToChain: 'Append to chain',
      disableUnavailableModels: 'Disable or remove unschedulable models before saving the policy.',
      fallbackTitle: 'Image job fallback rules',
      fallbackDescription: 'For image jobs, the selected model always runs first and later models require a retryable zero-output failure. Audio and video only check whether the selected model is enabled.',
      fallbackSelectedFirst: 'Selected model first',
      fallbackSameProvider: 'Same-provider compatibility only',
      fallbackRetryable: 'Retryable: 0, 429, 5xx',
      fallbackAccountFirst: 'Fail over accounts before models',
      fallbackPolicyNo: 'Content-policy blocks never fall back',
      auditVersion: 'Version',
      auditOperator: 'Operator',
      auditChange: 'Change summary',
      auditTime: 'Time',
      auditSwitchChanged: 'Policy switch changed to {state}',
      auditModelsChanged: 'Model chain changed from {before} to {after} items',
      auditVersionOnly: 'Policy version updated',
      recentJobsTitle: 'Recent image jobs',
      recentJobsDescription: 'Inspect the candidate chain, attempt latency, and final model used.',
      noRecentJobs: 'No image jobs have been recorded.',
      job: 'Job',
      jobStatus: 'Status',
      jobStatus_queued: 'Queued',
      jobStatus_running: 'Running',
      jobStatus_completed: 'Completed',
      jobStatus_partial: 'Partial',
      jobStatus_failed: 'Failed',
      jobStatus_indeterminate: 'Indeterminate',
      jobStatus_canceled: 'Canceled',
      jobStatus_expired: 'Expired',
      jobModel: 'Model',
      jobAttempts: 'Attempts / plan',
      jobOutput: 'Output',
      jobCreated: 'Created',
      collapseAttempts: 'Collapse attempt details',
      expandAttempts: 'Expand attempt details',
      attemptPlan: 'Attempt plan',
      attemptLog: 'Attempt log',
      noAttempts: 'No attempts recorded yet.',
      outputsShort: 'outputs',
      hideAttempts: 'Hide details',
      viewAttempts: 'View attempts',
      backendTitle: 'Backend logic and data access',
      backendDescription: 'Admission, scheduling, persistence objects, and parameterized queries used by Studio.',
      logicFlow: 'Execution flow',
      dataObjects: 'Data objects',
      sqlQueries: 'SQL queries',
      flowGate: 'Entry gate',
      flowGateDetail: 'Reads the user entry switch; route middleware rejects new requests when it is off.',
      flowConfig: 'Key and models',
      flowConfigDetail: 'Validates key ownership, state, and group before returning models available to that group.',
      flowPolicy: 'Attempt plan',
      flowPolicyDetail: 'Image jobs build a same-provider chain with the selected model first; audio and video only validate that their selected model is enabled.',
      flowReserve: 'Reservation',
      flowReserveDetail: 'Checks concurrency, estimates candidate cost, reserves funds, and queues the job transactionally.',
      flowWorker: 'Run and fallback',
      flowWorkerDetail: 'Workers fail over accounts first and only change models after a retryable zero-output failure.',
      flowPersist: 'Persistence',
      flowPersistDetail: 'Stores results, permanent assets, and canvas references, then settles or releases the reservation.',
      objectName: 'Object / table',
      objectPurpose: 'Responsibility',
      keyFields: 'Key fields',
      ownerModule: 'Owner module',
      objectSettings: 'Controls the user canvas route and new-job entry independently from model policy.',
      objectKeys: 'Locally selected caller credential linked to its user, group, state, and quota; plaintext keys are never returned.',
      objectGroups: 'Defines image admission, model allowlists, and billing behavior.',
      objectAccounts: 'Provider accounts and group bindings that supply model capabilities and scheduling coverage.',
      objectPolicy: 'Stores global model order, per-model state, and optimistic-lock version.',
      objectAudit: 'Records the operator and before/after snapshot for every policy update.',
      objectJobs: 'Stores async state, candidate plan, actual attempts, and the successful model.',
      objectResults: 'Stores provider output, object locations, permanent assets, and project references.',
      queryEntry: 'Read the user entry switch',
      queryCatalog: 'Calculate account / group / key coverage',
      queryPolicy: 'Read policy and audit',
      queryCreateJob: 'Reserve and create a job',
      queryWorker: 'Claim a job safely',
      queryAttempts: 'Record a model attempt',
      queryRecentJobs: 'List recent jobs'
    },
    ...
    settings: {
      ...
      imageCanvasEnabled: 'Enable Image Canvas',
      tabs: {
        general: 'General',
        agreement: 'Agreement',
      ...
      features: {
        imageCanvas: {
          title: 'Image Canvas',
          description: 'Enable the server-backed image generation workspace for users. Disabled by default.',
          enabledHint: 'When off, the user navigation entry and new canvas job creation remain unavailable.',
        },
        channelMonitor: {
          title: 'Channel Monitor',
