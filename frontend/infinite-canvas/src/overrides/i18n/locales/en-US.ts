...
export default {
    ...
    assets: {
        migrationPartial: "{{count}} local assets could not be migrated and will be retried next time",
        title: "My Assets",
        description: "Manage reusable text, image, video, and audio assets in one place.",
        ...
        deleteFailed: "Asset could not be deleted. Try again.",
    ...
    canvas: {
        ...
        apiKeys: {
            ...
            empty: "This account has no API keys",
            emptyTitle: "Create an API key to use Studio",
            emptyDescription: "Studio uses a Sub2API key from your account for access control, model permissions, and billing.",
            create: "Create API key",
            unavailableTitle: "No API key can use Studio",
            unavailableDescription: "Review your API keys and their groups. Studio needs an active key with access to an enabled image model.",
            configErrorTitle: "Studio configuration could not be loaded",
            configErrorDescription: "Check your connection and try again. Your projects have not been changed.",
            retry: "Try again",
            noGroup: "No group assigned",
            policyDisabled: "Image jobs are not globally enabled",
            reasons: {
                key_disabled: "Key is disabled",
                key_expired: "Key has expired",
                quota_exhausted: "Key quota is exhausted",
                group_missing: "No available group assigned",
                group_disabled: "Assigned group is disabled",
                image_generation_disabled: "Image generation is disabled for this group",
                no_image_model: "No image model is available in this group",
                unknown: "Unavailable for creation",
            },
        },
        ...
        sidePanel: {
            ...
            addingAssets: "Adding assets…", addedAssets: "Added {{count}} assets", mediaOnly: "Only image, video, or audio files are supported", addFailed: "Failed to add assets. Try again.", searchAssets: "Search assets", add: "Add", noAssets: "No assets", inserted: "Insert into canvas", removeAssetTitle: "Remove this asset?", remove: "Remove", removeAsset: "Remove asset", assetRemoved: "Asset removed", removeFailed: "Failed to remove the asset. Try again.",
        ...
        projectPage: {
            ...
            uploadFailedFallback: "Check the file format, size, or network and try again",
            noAudioToSave: "There is no audio to save",
            canvasAudio: "Canvas audio",
            assetSaveFailed: "Asset save failed: {{reason}}",
            assetSaveFailedFallback: "Check the network and try again",
            assetInsertFailed: "Asset could not be read: {{reason}}",
            assetInsertFailedFallback: "Check the network and try again",
            saveDirty: "Unsaved",
            saveSaving: "Saving",
            saveSaved: "Saved",
            saveError: "Local only",
        ...
        focusedEditor: {
            title: "Focused image editor", back: "Back to canvas", apply: "Apply", image: "Edited image", loading: "Loading editor", unavailable: "Editor unavailable", persistedRequired: "Choose a persisted image node from the canvas.", loadFailed: "Editor could not be loaded", modelRequired: "Select an image model and API key first", maskUnavailable: "The selected model does not support masked editing", promptRequired: "Enter instructions for the expanded area", nodeMissing: "The source image node no longer exists", applied: "Editor result applied to the canvas", revisions: "Versions", revision: "Version {{number}}", source: "Source", transform: "Edit", crop: "Crop", maskEdit: "Mask edit", backgroundReplace: "Replace background", outpaint: "Outpaint", outpaintPrompt: "Describe what should fill the expanded area", expand: "Expand canvas", view: "View", transparent: "Clear", white: "White", black: "Black", job: "Image task", job_idle: "Idle", job_running: "Working", job_completed: "Completed", job_failed: "Failed", job_canceled: "Canceled", cancelJob: "Cancel task", conflict: "This editor changed elsewhere", retrySave: "Retry local save", reload: "Use server copy", retry: "Retry", zoomOut: "Zoom out", zoomIn: "Zoom in", resetZoom: "Reset zoom", save_idle: "Ready", save_saving: "Saving", save_saved: "Saved", save_conflict: "Conflict", save_error: "Save failed"
        },
